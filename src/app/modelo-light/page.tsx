  ...
  return (
    <>
      <style>{`
        ...
        .btn-teal:hover { background-color: #C1C156; color: #072B31; }
        ...
        <div style={{ maxWidth: "64rem", margin: "0 auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "3rem", alignItems: "flex-start" }}>
            <div style={{ gridColumn: "span 1" }}>
              ...
              <p style={{ color: "#C1C156", fontFamily: "Inter, sans-serif", fontSize: "0.75rem", textTransform: "uppercase", letterSpacing: "0.15em", marginBottom: "0.75rem" }}>Quem vai te atender</p>
              <h2 className="font-serif" style={{ fontSize: "clamp(2rem, 4vw, 3rem)", color: "#072B31", fontWeight: 600, marginBottom: "0.5rem" }}>Dr. Leonardo Carvalho</h2>
            ...
            <div>
              <div style={{ backgroundColor: "#072B31", color: "#FFFFFF", padding: "2.5rem" }}>
                ...
                <div style={{ width: "32px", height: "1px", background: "#C1C156", marginTop: "1.5rem" }} />
      ...
      <section id="dor" className="section-white" style={{ padding: "3.5rem 1.5rem" }}>
        <div style={{ maxWidth: "48rem", margin: "0 auto" }}>
          <span style={{ ...goldAccent, marginBottom: "1.5rem" }} />
          <h2 className="font-serif" style={{ fontSize: "clamp(2rem, 4vw, 3rem)", color: "#072B31", fontWeight: 600, marginBottom: "2rem", lineHeight: 1.2 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "24px", color: "#4B5563", fontFamily: "Inter, sans-serif", fontSize: "1rem", lineHeight: 1.7 }}>
            ...
            <div style={{ backgroundColor: "#F9F6F1", borderLeft: "4px solid #C1C156", paddingLeft: "2rem", paddingTop: "1.5rem", paddingBottom: "1.5rem", margin: "0.5rem 0" }}>
              ...
              <p style={{ color: "#C1C156", fontSize: "0.75rem", textTransform: "uppercase", letterSpacing: "0.15em", marginTop: "1rem", fontWeight: 600 }}>Fonte: IBGE, 2024</p>
            </div>
            <p>
      ...
      <section id="virada" className="section-cream" style={{ padding: "3.5rem 1.5rem" }}>
        <div style={{ maxWidth: "64rem", margin: "0 auto" }}>
          <span style={{ ...goldAccent, marginBottom: "1.5rem" }} />
          <h2 className="font-serif" style={{ fontSize: "clamp(2rem, 4vw, 3rem)", color: "#072B31", fontWeight: 600, marginBottom: "1.5rem", lineHeight: 1.2 }}>
            ...
            {[
              ...
              <div key={i} className="card-hover-light section-white" style={{ border: "1px solid #F3F4F6", padding: "2rem" }}>
                <div style={{ width: "40px", height: "40px", backgroundColor: "rgba(11,40,40,0.05)", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "1.5rem" }}>
                  <div style={{ width: "20px", height: "1px", background: "#C1C156" }} />
                </div>
                <p className="font-serif" style={{ fontSize: "1.25rem", color: "#072B31", lineHeight: 1.6 }}>
                  {text}
                </p>
              </div>
            ))}
          </div>
          <div style={{ backgroundColor: "#072B31", color: "#FFFFFF", padding: "2rem", display: "flex", alignItems: "center", gap: "1.5rem" }}>
      ...
      <section id="como-funciona" className="section-white" style={{ padding: "3.5rem 1.5rem" }}>
        <div style={{ maxWidth: "56rem", margin: "0 auto" }}>
          <span style={{ ...goldAccent, marginBottom: "1.5rem" }} />
          <h2 className="font-serif" style={{ fontSize: "clamp(2rem, 4vw, 3rem)", color: "#072B31", fontWeight: 600, marginBottom: "1rem", lineHeight: 1.2 }}>
          ...
          <div style={{ backgroundColor: "#072B31", color: "#FFFFFF", padding: "1.5rem 2rem", display: "flex", alignItems: "center", gap: "1.5rem" }}>
            <div style={{ width: "4px", height: "40px", background: "#C1C156", flexShrink: 0 }} />
      ...
      <section id="diferencial" className="section-cream" style={{ padding: "3.5rem 1.5rem" }}>
        <div style={{ maxWidth: "64rem", margin: "0 auto" }}>
          ...
          <p style={{ color: "#C1C156", fontFamily: "Inter, sans-serif", fontSize: "0.75rem", textTransform: "uppercase", letterSpacing: "0.15em", fontWeight: 600, marginBottom: "1.5rem" }}>Aqui é diferente</p>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: "1.5rem" }}>
            {[
              ...
              <div key={i} className="card-hover-light section-white" style={{ border: "1px solid #F3F4F6", padding: "2rem", display: "flex", alignItems: "flex-start", gap: "20px" }}>
                <div style={{ width: "4px", height: "48px", background: "#C1C156", flexShrink: 0, marginTop: "4px" }} />
      ...
      <section id="escassez" className="section-white" style={{ padding: "3.5rem 1.5rem" }}>
        <div style={{ maxWidth: "48rem", margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "20px", color: "#4B5563", fontFamily: "Inter, sans-serif", fontSize: "1rem", lineHeight: 1.7 }}>
            <p>
              Para garantir análise individual e profundidade no diagnóstico, o número de atendimentos é intencionalmente limitado a <span style={{ color: "#072B31", fontWeight: 600 }}>10 por semana</span>.
            </p>
            <p>
      ...
      {/* CTA FINAL */}
      <section id="cta-final" style={{ backgroundColor: "#072B31", padding: "4rem 1.5rem" }}>
        <div style={{ maxWidth: "48rem", margin: "0 auto", textAlign: "center" }}>
          <span style={{ width: "48px", height: "1px", background: "#C1C156", display: "block", margin: "0 auto 2rem" }} />
      ...
      <footer className="section-cream" style={{ padding: "3rem 1.5rem", borderTop: "1px solid #E5E7EB" }}>
        <div style={{ maxWidth: "72rem", margin: "0 auto", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "1.5rem" }}>
          <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-start", gap: "8px" }}>
            <span className="font-serif" style={{ fontSize: "2rem", color: "#C1C156", letterSpacing: "0.04em", lineHeight: 1 }}>CT</span>
            <div className="font-serif" style={{ fontSize: "0.6rem", letterSpacing: "0.2em", color: "#072B31" }}>CARVALHO TEIXEIRA</div>
            <p className="font-serif" style={{ color: "#C1C156", fontSize: "0.875rem", fontStyle: "italic" }}>Para quem tem muito a preservar</p>
          </div>
